...
def pq_compute_single_img(categories, gt_ann, pan_gt, pred_ann, pan_pred):
    pq_stat = PQStat()
    ...
    for label, label_cnt in zip(labels, labels_cnt):
        ...
        pred_segms[label]['area'] = int(label_cnt)
...
def pq_compute_single_core(proc_id, annotation_set, gt_folder, pred_folder, categories):
    ...
    for gt_ann, pred_ann in annotation_set:
        ...
        _single_img_stat = pq_compute_single_img(
            categories, gt_ann, pan_gt, pred_ann, pan_pred)
