...
class PCV_Boundless(PCV_base):
    def __init__(self):
        ...
        self.boundless_vote_mask = \
            Snake.paint_bound_ignore_trail_mask(field_diam, grid_spec)
    ...
    def discrete_vote_inx_from_offset(self, offset):
        # note that when assigning votes, use the boundary ignore vote mask
        return self._discretize_offset(self.boundless_vote_mask, offset)
